  ...
  <div v-loading="loading" class="project-group">
    ...
    >
      ...
      >
        ...
        <div v-show="data.dropdownShow && isEdit" @click.stop="() => {}">
          <el-dropdown placement="right-start" trigger="hover">
            <i class="el-icon-more"></i>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                icon="el-icon-plus"
                @click.native="addPeerTree(node, data)"
                >新增分组</el-dropdown-item
              >
              <el-dropdown-item
                icon="el-icon-circle-plus"
                @click.native="addChildrenTree(node, data)"
                >新增子分组</el-dropdown-item
              >
              <el-dropdown-item
                icon="el-icon-edit-outline"
                @click.native="updateTree(node, data)"
                >编辑分组</el-dropdown-item
              >
              <el-dropdown-item
                icon="el-icon-delete-solid"
                @click.native="delTree(node, data)"
